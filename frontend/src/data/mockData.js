...
export const warehouses = [
  { name: 'مستودع الرمال اللوجستي', city: 'الرياض', size: '1200 م²', price: '12,500 SAR', status: statusValues.active },
  { name: 'مركز التخزين الحديث', city: 'جدة', size: '900 م²', price: '9,800 SAR', status: statusValues.pendingReview },
  { name: 'مستودعات بوابة الشرق', city: 'الدمام', size: '1500 م²', price: '18,000 SAR', status: statusValues.active },
]
...
export const dashboardShowcaseContent = {
  ...
  sharedStats: [
    ...
    { label: 'الحجوزات النشطة', value: '128' },
  ],
  sections: {
    admin: {
    ...
    owner: {
      ...
      highlights: [
        { label: 'المستودعات', value: '08' },
        { label: 'الطلبات الجديدة', value: '13' },
        { label: 'الإيراد الشهري', value: '84,000 SAR' },
      ],
      warehouses: [
        { name: 'مستودع الرمال اللوجستي', city: 'الرياض', status: statusValues.active },
        { name: 'مركز التخزين الحديث', city: 'جدة', status: statusValues.inactive },
    ...
    renter: {
      ...
      highlights: [
        { label: 'الحجوزات الحالية', value: '03' },
        { label: 'الدفعات المكتملة', value: '06' },
